          ...
          <div class="user-block">
            ...
            <div class="user-block__content">
              <form v-on:submit.prevent autocomplete="off">
                ...
                >
                  <label for="reset-form-passwordConfirm"
                ...
                <div class="mt-4 small">
                  <p>
                    Not signed up yet?
                    <router-link to="/user/signup">Signup here.</router-link>
                  </p>
  ...
  methods: {
    async submit() {
      ...
      try {
        ...
        this.$toasted.error(
          "Your reset link has expired or is incorrect. Please reset your password again."
        );
      } finally {
        this.pending = false;
      }

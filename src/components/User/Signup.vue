            ...
            <div class="user-block__content">
              <form v-on:submit.prevent autocomplete="off">
                <div
                  class="form-group"
                  v-bind:class="{
                    'form-group--error': $v.credentials.firstName.$error,
                    'form-group--success':
                      !$v.credentials.firstName.$invalid &&
                      $v.credentials.firstName.$dirty
                  }"
                >
                  <label id="signup-form-firstName">First Name</label>
                  <input
                    autofocus
                    autocomplete=""
                    type="text"
                  ...
                  <div
                    ...
                    v-if="$v.credentials.firstName.$error"
                  >
                ...
                <div
                  class="form-group"
                  v-bind:class="{
                    'form-group--error': $v.credentials.lastName.$error,
                    'form-group--success':
                      !$v.credentials.lastName.$invalid &&
                      $v.credentials.lastName.$dirty
                  }"
                >
                  <label for="signup-form-lastName">Last Name</label>
                  <input
                    type="text"
                    class="form-control"
                  ...
                  <div
                    class="form-group__message"
                    v-if="$v.credentials.lastName.$error"
                  >
                ...
                <div
                  class="form-group"
                  v-bind:class="{
                    'form-group--error': $v.credentials.email.$error,
                    'form-group--success':
                ...
                <div
                  class="form-group"
                  v-bind:class="{
                    'form-group--error': $v.credentials.passwordConfirm.$error,
                    'form-group--success':
                      !$v.credentials.passwordConfirm.$invalid &&
                      $v.credentials.passwordConfirm.$dirty
                  }"
                >
                  <label for="signup-form-passwordConfirm"
                  ...
                  <div
                    class="form-group__message"
                    v-if="$v.credentials.passwordConfirm.$error"
                  >
                    Entry doesn't match.
                  </div>
                </div>
